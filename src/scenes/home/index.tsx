    ...
    >
        ...
        className='md:flex mx-auto w-5/6 items-center justify-center md:h-5/6'>
            ...
            {/* heading */}
                ...
                className='md:-mt-30'>
                    ...
                    <p className='mt-8 text-sm'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo voluptatem, debitis molestiae numquam temporibus vel praesentium. Id eum nulla blanditiis modi eos rerum nesciunt voluptatem saepe ducimus, dolorum odio libero?
                    </p>
                </motion.div>
                {/* actions */}
                <motion.div
            ...
            <div className='flex basis-3/5 justify-center md:z-10
                md:ml-40 md:mt16 md:justify-items-end'>
                <img src={HomePageGraphics} alt="home-pageGraphic" />
            </div>
        </motion.div>
